...
<div class="container">
    ...
    <?php if (empty($orders)): ?>
        <div class="empty-state">
            ...
            <a href="<?= url('menu') ?>" class="btn btn-primary mt-2"><i class="bi bi-grid"></i> Lihat Menu</a>
        </div>
    <?php else: ?>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?= url('track-order?no=' . urlencode($o['no_pesanan'])) ?>" class="btn btn-secondary btn-sm"><i class="bi bi-eye"></i> Jejak</a></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
